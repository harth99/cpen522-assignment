...
public class FirefoxTest {
    ...
    public void testSearchPos() {
        ...
        WebElement unorderedList = driver.findElement(By.className("product_list"));
    ...
    public void testCheckoutProcessPos() {
        ...
        WebDriverWait waitProcessAddress = new WebDriverWait(driver, Duration.ofMillis(10000));
        WebElement processAddress = waitProcessAddress.until(ExpectedConditions.presenceOfElementLocated(By.cssSelector("button.button.btn.btn-default.button-medium[name='processAddress']")));
